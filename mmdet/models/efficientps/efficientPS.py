...
class EfficientPS(BaseDetector):
    ...
    def simple_test_panoptic(self,
        ...
        if self.reverse_classes:
            semantic_logits = torch.cat([semantic_logits[:, self.num_thing:, ...],
                                         semantic_logits[:, :self.num_thing, ...]], dim=1)
        ...
        if det_bboxes.shape[0] == 0:
            ...
            bbx_idx = torch.arange(0, _bboxes.size(0), 
            ...
            del mask_feats, mask_pred, mask_rois, _bboxes, bbx_inv, bbx_idx, occupied, intersection, mask_i, ML_A, ML_B, FL
        ...
        del intermediate_mask, unique, ignore_arr, total_unique, ignore_val, cls_stuff, area, tmp, new_sem_pred, bool_mask    
