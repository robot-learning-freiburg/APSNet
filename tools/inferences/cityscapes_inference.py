...
from mmdet.core.evaluation.dataset_labels import cs_trainId2label
        ...
        for imgName in os.listdir(path):
            ...
            for panPredId in panPredIds:
                if cat_pred[panPredId] == 255:
                    ...
                    semanticId = segmentId = cs_trainId2label[cat_pred[panPredId]].id 
                else:
                    semanticId = cs_trainId2label[cat_pred[panPredId]].id
